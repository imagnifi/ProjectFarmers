...
/**
 * The base model implementation for the District service. Represents a row in the &quot;district_details&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DistrictModelImpl extends BaseModelImpl<District>
     ...
     */
    public static final String TABLE_NAME = "district_details";
    ...
    public static final String TABLE_SQL_CREATE = "create table district_details (uuid_ VARCHAR(75) null,districtId LONG not null primary key,name VARCHAR(75) null,number_ INTEGER,status BOOLEAN)";
    public static final String TABLE_SQL_DROP = "drop table district_details";
    public static final String ORDER_BY_JPQL = " ORDER BY district.name DESC";
    public static final String ORDER_BY_SQL = " ORDER BY district_details.name DESC";
    ...
    public void resetOriginalValues() {
        ...
        districtModelImpl._originalUuid = districtModelImpl._uuid;
