...
import ru.imagnifi.model.DistrictClp;
import ru.imagnifi.model.FarmerClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "Farmer-1.0-SNAPSHOT-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "Farmer-1.0-SNAPSHOT";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals("ru.imagnifi.model.impl.DistrictImpl")) {
        ...
        if (oldModelClassName.equals("ru.imagnifi.model.impl.FarmerImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("ru.imagnifi.NoSuchDistrictException")) {
            return new ru.imagnifi.NoSuchDistrictException();
        }

        if (className.equals("ru.imagnifi.NoSuchFarmerException")) {
            return new ru.imagnifi.NoSuchFarmerException();
        }
