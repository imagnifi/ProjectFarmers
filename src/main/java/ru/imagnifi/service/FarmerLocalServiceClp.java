...
public class FarmerLocalServiceClp implements FarmerLocalService {
    ...
    public FarmerLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName37 = "addFarmerDistricts";

        _methodParameterTypes37 = new String[] {
                "ru.imagnifi.model.Farmer", "java.lang.String"
            };

        _methodName38 = "addFarmerDistricts";

        _methodParameterTypes38 = new String[] { "long", "long[][]" };

        _methodName39 = "deleteFarmerDistricts";
    ...
    public ru.imagnifi.model.Farmer addFarmer(ru.imagnifi.model.Farmer farmer)
        ...
        return (ru.imagnifi.model.Farmer) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<ru.imagnifi.model.Farmer> getFarmers(int start,
        ...
        return (java.util.List<ru.imagnifi.model.Farmer>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public ru.imagnifi.model.Farmer addFarmer(java.lang.String organization,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName35,
                    ...
                    ClpSerializer.translateInput(orgForm),
                    ...
                    ClpSerializer.translateInput(shownDistricts),
    ...
    public java.lang.String getListSownDistricts(long farmerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName36,
                    _methodParameterTypes36, new Object[] { farmerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void addFarmerDistricts(ru.imagnifi.model.Farmer farmer,
        ...
        try {
            _invokableLocalService.invokeMethod(_methodName37,
                ...
                ClpSerializer.translateInput(districtIds)
                });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public void updateFarmerCust(ru.imagnifi.model.Farmer farmer)
        ...
        try {
            ...
            if (t instanceof ru.imagnifi.NoSuchFarmerException) {
                throw (ru.imagnifi.NoSuchFarmerException) t;
            }
